document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "RASHI"; // Replace with dynamic value
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text">I knew you would say yes finally yay!💕</span>`;
